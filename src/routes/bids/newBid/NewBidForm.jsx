...
const NewBidForm = ({ onSubmit, securities }) => {
  const {
    register,
        ...
        <div className="form__field field has-addons">
          <div className="control">
            <Select
              ...
              options={securities}
              onChange={value => {
                setValue('selectedSecurityName', value[0].name);
                setValue('selectedSecurityId', value[0].id);
              }}
            />
          </div>
          ...
          <div className="estimate__amount">
            ...
            <span className="estimate__amount--amount">
              {validateMoneyString(watchedFields.price)
                ? (
                    watchedFields.price * watchedFields.numShares
                  ).toLocaleString()
                : '-'}
            </span>
          </div>
