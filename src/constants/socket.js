...
export const EMIT_ARCHIVE_CHATROOM = 'req_archive_chatroom';
export const EMIT_UNARCHIVE_CHATROOM = 'req_unarchive_chatroom';
...
export const RECEIVE_ARCHIVE_CHATROOM = 'res_archive_chatroom';
export const RECEIVE_UNARCHIVE_CHATROOM = 'res_unarchive_chatroom';
